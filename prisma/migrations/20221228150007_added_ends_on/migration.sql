...
INSERT INTO "new_Match" ("endUserFeedback", "endUserId", "endUserJoined", "id", "sourceUserFeedback", "sourceUserId", "sourceUserJoined", "status") SELECT "endUserFeedback", "endUserId", "endUserJoined", "id", "sourceUserFeedback", "sourceUserId", "sourceUserJoined", "status" FROM "Match";
DROP TABLE "Match";
