...
const WaitingPage: NextPage = () => {
  ...
  return (
    <div>
      ...
      <h1 className="text-5xl text-center font-semibold bg-gradient-to-r from-sky-400 to-cyan-300 text-transparent bg-clip-text p-4 mb-10">Waiting for Users to Join...</h1>
      <div role="status">
